// Yokohama · Minatokokoro vocabulary, v1.0 (Q2 2026).
...
//
// Localization caveat: all Japanese (kanji, kana, romaji) here is a Q2 2026 design
...
// district that routinely permits 200+ metre towers (Landmark Tower 296m). The 120m
// Minatokokoro fits the skyline without special legislation, scaled to MM21 not to
// a generic global trophy height. Yokohama also has the
...
const vocab = {
  ...
  monument: {
    ...
    name: "Minatokokoro",
    completionYear: 2036,
    signature: "A 120 metre Port Heart on Pier 8 of Minato Mirai 21. Yokohama's Landmark Tower is 296 metres and the MM21 skyline routinely permits 200+ metre towers, so 120 is the city's family-scale answer to the towers around it: tall enough to read from the bay, short enough to sit under at human scale. Stacked CLT timber pavilions on a base-isolated steel frame. Magenta-rose tinted glass curtain wall, patinated copper roof shells, andesite plinth. Sister piers reach toward the bay so the silhouette doubles in the water at evening. Not the tallest tower in MM21. The most lived-in."
  },
  nationalStyle: {
    materials: [
      ...
      { name: "Weathering steel",              sourceRegion: "Kawasaki shipyards, neighbouring Yokohama", role: "Bay-facing structural frame, patina referencing the working port heritage" },
  ...
  sections: {
    hero: {
      ...
      stats: [
        { n: "120m",     l: "Minatokokoro Monument" },
    ...
    monumentSection: {
      label: "港心",
      title: "Minatokokoro",
      lead: "The Port Heart. 120 metres of stacked CLT timber pavilions on a base-isolated steel frame, sited on Minato Mirai 21 Pier 8 with sister piers reaching into the bay. Sized to the MM21 skyline (Landmark Tower is 296 m, the supertall context allows it). Magenta-rose tinted glass curtain wall, patinated copper roof shells, andesite plinth tied to Hakone volcanic geology.",
    ...
    architecture: {
      ...
      lead: "Heart-shaped buildings in CLT timber and weathering steel. Existing concrete walls along Bashamichi and Isezaki wrapped in seasonal lantern lattice, lit at dusk to mirror the bay-front promenade lanterns the city has loved since 1860.",
      viral: "Other cities have a skyline. Yokohama has a horizon line, doubled in the water.",
      murals: [
        { text: "おかえり",  sub: "Welcome home. Lantern lattice on a south-facing wall in Kanagawa-ku, deep rose against weathering steel.",      gradient: "linear-gradient(135deg,#d63384,#7a1c4d)" },
    ...
    media: {
      ...
      lead: "Yokohama does not run a separate station. The Cor del Món network broadcast is anchored in Andorra (Cor FM, Cor Play). Yokohama contributes the Yokohama Hour: a weekly two-hour Japanese-language strand that goes out at 18:00 JST every Sunday from 2036 onward, recorded in a small studio inside Minatokokoro and rebroadcast worldwide via Cor Play. The existing FM Yokohama, NHK Yokohama, and TVK stay in place; Yokohama Hour is a contribution into the network, not a new station.",
      viral: "We did not need another radio station. We needed an hour the network listens to.",
      soundtrackTitle: "横浜の音 · The Sound of Yokohama",
      soundtrackIntro: "City pop, bayside jazz, and the new wave of Yokohama-born producers. A short set chosen to capture the way the port sounds at 18:00 JST on a humid summer Sunday. Click any track to open a YouTube search.",
      soundtrack: [
        { track: "Plastic Love",            artist: "Mariya Takeuchi",              released: 1984, note: "City pop's defining track, recorded with husband Tatsuro Yamashita. Yokohama is the city pop capital because FM Yokohama played it on heavy rotation when the rest of Japan would not." },
        { track: "Bay Bridge Serenade",     artist: "Naoya Matsuoka & Wesing",       released: 1989, note: "Bay-jazz fusion written for the Yokohama Bay Bridge opening. The Minato Mirai sound before MM21 was finished." },
        { track: "Last Summer Whisper",     artist: "Anri",                          released: 1982, note: "Sun-bleached city pop ballad in English and Japanese. The port at the end of August, when the humidity finally breaks." },
        { track: "Plastic Love (Friday Night Plans cover)", artist: "Friday Night Plans", released: 2020, note: "The new generation reinterprets the classic. Friday Night Plans is the Tokyo-Yokohama corridor's quiet bedroom-pop voice." }
      ]
    },
    traditions: {
      label: "伝統の再解釈",
    ...
    roadmap: {
      ...
      milestones: [
        ...
        },
        {
          ...
          metrics: { homes: 1000, monumentHeightM: 120, fertilityRate: 1.5, residentsIncoming: 10, dailyCeremonyActive: true },
  ...
  feasibility: {
    ...
    items: [
      ...
      { area: "Compliance",            detail: "Building Standard Law of Japan (建築基準法), MLIT 2025 amendment, plus Yokohama Bayfront District design guidelines. 120m height verified as within MM21 supertall context (Landmark Tower 296m, Cosmo Clock 21 ferris wheel 112m, routine 200m+ towers)." }
    ]
  },
  costs: {
  ...
  impact: {
    ...
    items: [
      ...
      { metric: "120m bayfront landmark",                     note: "Sized to MM21 (Landmark Tower 296m), so reads family-scale rather than supertall trophy. Visible from across the bay; doubled in the water at evening." },

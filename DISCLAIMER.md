...
- investment advice or investment solicitation
- architectural, structural-engineering, or seismic-engineering advice
- urban-planning, zoning, or land-use advice
- immigration, residency, or visa advice
- heritage-conservation, indigenous-affairs, or cultural-heritage advice
- public-policy, fiscal-policy, or governmental advice
- safety, fire-protection, or building-code advice
- environmental, water-management, or climate-policy advice
- medical, mental-health, fertility, or family-planning advice

Anyone considering action on any topic touched by this proposal must consult qualified professionals licensed in the relevant jurisdiction.
...
- any pre-existing relationship, partnership, contract, or affiliation
- any endorsement, approval, or review by the named entity
- any communication, contact, or solicitation initiated with the named entity
- any commitment by the named entity to participate, fund, partner, or otherwise act
- any representation of the named entity's positions, plans, or available resources
...
- treating any built-form, public-installation, or naming use of Indigenous content as gated on documented Traditional Custodian consent.

For Adelaide / Tarndanyangga, this means **Kaurna Yerta Aboriginal Corporation** consent under the SA Aboriginal Heritage Act 1988. For Cape Town, this means consent of Khoekhoen and San community organisations recognised by the Department of Cooperative Governance. The project's open invitation is documented at `_shared/language-review.md`.

## 6. Non-English content (Catalan, Japanese, Chilean Spanish, Hindi, Afrikaans, isiXhosa)

All non-English content on this site is a Q3 2026 design proposal generated by the project authors and **awaits review by native speakers** before any real-world implementation. Where non-English content is presented, the English gloss is the primary intended meaning; the non-English form is a creative-research draft.

## 7. Architectural, structural, and engineering content

Building heights (a uniform 12m, plus a night-time projected heart of light), materials, seismic specifications, base-isolation approaches, curtain-wall systems, jali geometry counts, hempcrete formulations, rammed-earth specifications, and every other architectural or engineering claim are conceptual design references. None has been engineered, peer-reviewed, or approved.

Real construction would require:

- a licensed architect-of-record in each jurisdiction;
- a licensed structural engineer compliant with the applicable code (Eurocode 8, Building Standard Law of Japan, AS 1170.4, NCh433/NCh2745, SANS 10160-4, IS 1893);
- statutory building-permit review;
- where applicable, statutory seismic peer review by an authorised performance-evaluation organisation;
- environmental impact assessment;
- public consultation under each jurisdiction's planning law.

The named reference architects, engineering firms, and review bodies are cited as historical, stylistic, or precedent references. No commission, partnership, or current-project relationship is claimed.

## 8. Heritage, UNESCO, and World Heritage content

The proposal references **UNESCO World Heritage** sites (Valparaíso 2003, Jaipur 2019), **State Party** plans, and World Heritage Committee decisions, including but not limited to the November 2025 Outstanding Universal Value safeguarding concerns flagged for Jaipur.
...
City names, country names, place names, government bodies, and indigenous-language terms remain property of their respective owners and communities. References to:

- corporate trademarks (Mitsubishi Estate, Growthpoint Properties, V&A Waterfront, Akashvani, NHK Yokohama, FM Yokohama, ABC Adelaide, Cape Talk, etc.)
- registered foundations (Tata Trusts, Aga Khan Trust for Culture, Oppenheimer Memorial Trust, etc.)
- registered architectural practices (Foreign Office Architects, SANAA, Studio Mumbai, etc.)
...
## 10. Funding, costs, and budget references

Cost ranges quoted (Andorra USD 10 to 15M, Yokohama USD 200 to 350M, Adelaide USD 80 to 120M, Valparaíso USD 40 to 70M, Cape Town USD 120 to 180M, Jaipur USD 15 to 30M, network total USD 465 to 765M) are **rough order-of-magnitude estimates** anchored against published comparables. They are not committed budgets, not bids, not contractor estimates, and not commitments of any kind. Real construction budgets would emerge only after international design competitions, detailed engineering, statutory review, and procurement, and would differ materially.

References to funding sources (existing government housing programmes, cultural-ministry capital lines, named foundations, philanthropic vehicles) are descriptive of where funding **could** plausibly come from in a real implementation. No funding has been raised, applied for, awarded, committed, or accepted.

## 11. Adjustment, revision, and primacy of local reality

Every figure, site, partnership, programme, and timeline on this site **is subject to revision** on:

- government review and the named ministries' actual priorities;
- community feedback from the cities and Traditional Custodian organisations involved;
- professional consultation in each domain;
- independent reality.

**Where this proposal conflicts with existing law, regulation, or community will in any city, the existing law, regulation, or community will prevails.** The proposal is unilateral and unsolicited; it adjusts to the world, not the other way around.

## 12. Safety

The website discusses building heights, seismic isolation, water-positive design, and other technical topics. No safety claim made anywhere on this site is verified, certified, or appropriate for design or construction use. Real building safety is the responsibility of licensed professionals working within statutory review in each jurisdiction.

## 13. No warranty, no liability

The site is provided **"as is", without warranty of any kind**, express or implied, including but not limited to fitness for any particular purpose, accuracy, completeness, currency, or non-infringement. To the maximum extent permitted by applicable law, neither **sara-star-quant** (the project author), nor any contributor, reviewer, or named third party shall be liable for any direct, indirect, incidental, special, consequential, or exemplary damages arising from any use of, reliance on, or inability to use the site or any content within it.

This limitation applies even if a contributor has been advised of the possibility of such damages and even if a remedy fails of its essential purpose.
...
*By using this site, you acknowledge that you have read this disclaimer in full. The summary on every city page links here. The disclaimer governs the entire site, including past and future versions.*
